...
public class ResumeBuilder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dateXIIField.setText("DD-MM-YY");

        dateXLabel.setText("Date");

        dateXField.setText("DD-MM-YY");

        jMenu1.setText("File");

        openNewWindow.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N, java.awt.event.InputEvent.CTRL_DOWN_MASK));
