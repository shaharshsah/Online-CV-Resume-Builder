...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username){
        ...
        setBounds(100, 20, 1200, 750);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("qizz/icons/quiz.jpg"));
        ...
        lifeline.setBounds(900, 580, 200, 30);
        ...
        submit.setBounds(900, 620, 200, 30);
        add(submit);
